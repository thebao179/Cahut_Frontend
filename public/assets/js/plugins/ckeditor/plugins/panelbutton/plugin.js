      ...
      proto: {
        createPanel(c) {
          ...
          if (!b.panel) {
            ...
            const e = this._.panelDefinition.block;
            const h = f.parent || CKEDITOR.document.getBody();
            const d = (this._.panel = new CKEDITOR.ui.floatPanel(c, h, f));
            var f = d.addBlock(b.id, e);
            const a = this;
            const g = c.getCommand(this.command);
            d.onShow = function () {
