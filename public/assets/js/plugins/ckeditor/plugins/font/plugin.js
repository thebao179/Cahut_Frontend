...
(function () {
  function k(a, b) {
    const c = a.config;
    const e = b.lang;
    const d = new CKEDITOR.style(b.styleDefinition);
    const f = new l({
      entries: b.entries,
    ...
    a.addCommand(b.commandName, {
      exec(a, b) {
        const c = b.newStyle;
        const d = b.oldStyle;
        const e = a.getSelection().getRanges()[0];
        const f = void 0 === c;
        if (d || c)
    ...
    a.ui.addRichCombo(b.comboName, {
      ...
      contentTransformations:
        b.styleDefinition.element === "span"
          ? [
              [
                {
                  element: "font",
      ...
      init() {
        const b = `(${a.lang.common.optionDefault})`;
  ...
  function n(a, b) {
    ...
    const c = (function (a, b) {
      const c = a.getDefinition().attributes;
      const e = b.getDefinition().attributes;
  ...
  var l = CKEDITOR.tools.createClass({
    ...
    proto: {
      ...
      addToCombo(a) {
        for (let b = 0; b < this._.names.length; b++) {
          const c = this._.names[b];
