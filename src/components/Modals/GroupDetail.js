                                    ...
                                    <table className="table table-bordered table-striped table-vcenter"
                                        ...
                                        <tr>
                                            ...
                                            <td className="d-none d-sm-table-cell">
                                                <span
                                                    className="fs-xs fw-semibold d-inline-block py-1 px-3 rounded-pill bg-warning-light text-warning">Owner</span>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td className="d-none d-sm-table-cell">
                                                <span
                                                    className="fs-xs fw-semibold d-inline-block py-1 px-3 rounded-pill bg-info-light text-info">Co-Owner</span>
                                            </td>
                                            <td>
                                                <button type="button" className="text-center btn btn-sm btn-danger">
                                                    <i className="fa fa-fw fa-xmark"></i>
                                        ...
                                        <tr>
                                            ...
                                            <td className="d-none d-sm-table-cell">
                                                <span
                                                    className="fs-xs fw-semibold d-inline-block py-1 px-3 rounded-pill bg-success-light text-success">Member</span>
                                            </td>
                                            <td>
                                                <button type="button" className="text-center btn btn-sm btn-danger">
                                                    <i className="fa fa-fw fa-xmark"></i>
