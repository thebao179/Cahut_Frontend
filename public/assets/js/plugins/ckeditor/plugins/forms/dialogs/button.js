  ...
  function d(a) {
    ...
    b
      ? ((a.attributes[this.id] = b),
        this.id == "name" && (a.attributes["data-cke-saved-name"] = b))
      : (delete a.attributes[this.id],
        this.id == "name" && delete a.attributes["data-cke-saved-name"]);
  }
  return {
